...
type UpdateVolumeRequest struct {
	...
	//
	// The volume's `project_id` and `id` fields are used to identify the volume to update.
	Volume *Volume `protobuf:"bytes,1,opt,name=volume,proto3" json:"volume,omitempty"`
...
const file_svc_compute_volume_volume_svc_proto_rawDesc = "" +
	"\n" +
	"#svc/compute/volume/volume_svc.proto\x12\x13org.cudo.compute.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\x1a\x19google/type/decimal.proto\x1a$gnostic/openapi/v3/annotations.proto\x1a\x1fsvc/compute/volume/volume.proto\"O\n" +
	"\x13CreateVolumeRequest\x128\n" +
	"\x06volume\x18\x01 \x01(\v2\x1b.org.cudo.compute.v1.VolumeB\x03\xe0A\x02R\x06volume\"N\n" +
	...
	"pageNumber\x12 \n" +
	"\tpage_size\x18\x04 \x01(\x05B\x03\xe0A\x02R\bpageSize\"\x8c\x01\n" +
	"\x13UpdateVolumeRequest\x128\n" +
	"\x06volume\x18\x01 \x01(\v2\x1b.org.cudo.compute.v1.VolumeB\x03\xe0A\x02R\x06volume\x12;\n" +
