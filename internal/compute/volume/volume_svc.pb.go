...
const file_svc_compute_volume_volume_svc_proto_rawDesc = "" +
	"\n" +
	"#svc/compute/volume/volume_svc.proto\x12\x13org.cudo.compute.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\x1a\x1fsvc/compute/volume/volume.proto\"J\n" +
	...
	"\x17ListVolumePricesRequest\x12$\n" +
	...
	"updateMask2\xdf\x06\n" +
	"\rVolumeService\x12\x8f\x01\n" +
	"\fCreateVolume\x12(.org.cudo.compute.v1.CreateVolumeRequest\x1a\x1b.org.cudo.compute.v1.Volume\"8\x82\xd3\xe4\x93\x022:\x06volume\"(/v1/projects/{volume.project_id}/volumes\x12\x80\x01\n" +
	"\fDeleteVolume\x12(.org.cudo.compute.v1.DeleteVolumeRequest\x1a\x16.google.protobuf.Empty\".\x82\xd3\xe4\x93\x02(*&/v1/projects/{project_id}/volumes/{id}\x12\x7f\n" +
	"\tGetVolume\x12%.org.cudo.compute.v1.GetVolumeRequest\x1a\x1b.org.cudo.compute.v1.Volume\".\x82\xd3\xe4\x93\x02(\x12&/v1/projects/{project_id}/volumes/{id}\x12\x8b\x01\n" +
	"\x10ListVolumePrices\x12,.org.cudo.compute.v1.ListVolumePricesRequest\x1a-.org.cudo.compute.v1.ListVolumePricesResponse\"\x1a\x82\xd3\xe4\x93\x02\x14\x12\x12/v1/volumes/prices\x12\x8b\x01\n" +
	"\vListVolumes\x12'.org.cudo.compute.v1.ListVolumesRequest\x1a(.org.cudo.compute.v1.ListVolumesResponse\")\x82\xd3\xe4\x93\x02#\x12!/v1/projects/{project_id}/volumes\x12\x9b\x01\n" +
	"\fUpdateVolume\x12(.org.cudo.compute.v1.UpdateVolumeRequest\x1a\x1b.org.cudo.compute.v1.Volume\"D\x82\xd3\xe4\x93\x02>:\x06volume24/v1/projects/{volume.project_id}/volumes/{volume.id}BIZGgithub.com/CudoVentures/terraform-provider-cudo/internal/compute/volumeb\x06proto3"
...
func file_svc_compute_volume_volume_svc_proto_init() {
	...
	file_svc_compute_volume_volume_svc_proto_msgTypes[3].OneofWrappers = []any{}
	file_svc_compute_volume_volume_svc_proto_msgTypes[5].OneofWrappers = []any{}
	type x struct{}
