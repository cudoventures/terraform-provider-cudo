...
const (
	...
	Machine_UPDATING          Machine_State = 6
)
...
type Cluster struct {
	...
	// Configuration for IP over InfiniBand networking.
	IpoibConfig   *ClusterIPOIBConfig `protobuf:"bytes,27,opt,name=ipoib_config,json=ipoibConfig,proto3" json:"ipoib_config,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Cluster) GetIpoibConfig() *ClusterIPOIBConfig {
	if x != nil {
		return x.IpoibConfig
	}
	return nil
}

type ClusterIPOIBConfig struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The network prefix in CIDR format (e.g. "172.24.0.0/13").
	NetworkPrefix string `protobuf:"bytes,1,opt,name=network_prefix,json=networkPrefix,proto3" json:"network_prefix,omitempty"`
	// The number of bits following the network prefix that are used for the port portion of the address (e.g. 3). The maximum number of ports per host will be 2 raised to the power of this value.
	PortBits int32 `protobuf:"varint,2,opt,name=port_bits,json=portBits,proto3" json:"port_bits,omitempty"`
	// The number of bits following the port portion that are used for the host portion of the address (e.g. 16). The maximum number of hosts will be 2 raised to the power of this value, minus 2 (for network and broadcast addresses).
	HostBits      int32 `protobuf:"varint,3,opt,name=host_bits,json=hostBits,proto3" json:"host_bits,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ClusterIPOIBConfig) Reset() {
	*x = ClusterIPOIBConfig{}
	mi := &file_svc_compute_baremetal_baremetal_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ClusterIPOIBConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ClusterIPOIBConfig) ProtoMessage() {}

func (x *ClusterIPOIBConfig) ProtoReflect() protoreflect.Message {
	mi := &file_svc_compute_baremetal_baremetal_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ClusterIPOIBConfig.ProtoReflect.Descriptor instead.
func (*ClusterIPOIBConfig) Descriptor() ([]byte, []int) {
	return file_svc_compute_baremetal_baremetal_proto_rawDescGZIP(), []int{4}
}

func (x *ClusterIPOIBConfig) GetNetworkPrefix() string {
	if x != nil {
...
func (x *ClusterIPOIBConfig) GetPortBits() int32 {
	if x != nil {
		return x.PortBits
	}
	return 0
...
func (x *ClusterIPOIBConfig) GetHostBits() int32 {
	if x != nil {
		return x.HostBits
	}
	return 0
...
const file_svc_compute_baremetal_baremetal_proto_rawDesc = "" +
	"\n" +
	"%svc/compute/baremetal/baremetal.proto\x12\x13org.cudo.compute.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x19google/type/decimal.proto\x1a\x1fsvc/compute/sshkey/sshkey.proto\x1a\x17svc/compute/types.proto\x1a\x17svc/compute/vm/vm.proto\"\xbe\x04\n" +
	"\vMachineType\x12)\n" +
	...
	"\ripv4_price_hr\x18\x05 \x01(\v2\x14.google.type.DecimalB\x03\xe0A\x02R\vipv4PriceHr\"\xf7\t\n" +
	"\aMachine\x12)\n" +
	"\x0edata_center_id\x18\x01 \x01(\tB\x03\xe0A\x02R\fdataCenterId\x12\x13\n" +
	"\x02id\x18\x02 \x01(\tB\x03\xe0A\x02R\x02id\x12+\n" +
	...
	"\fstart_script\x18\x1a \x01(\tB\x03\xe0A\x04R\vstartScript\"o\n" +
	"\x05State\x12\x15\n" +
	...
	"createTime\x12 \n" +
	"\tcreate_by\x18\x1a \x01(\tB\x03\xe0A\x03R\bcreateBy\x12O\n" +
	"\fipoib_config\x18\x1b \x01(\v2'.org.cudo.compute.v1.ClusterIPOIBConfigB\x03\xe0A\x05R\vipoibConfig\"`\n" +
	"\x05State\x12\x15\n" +
	"\x11STATE_UNSPECIFIED\x10\x00\x12\f\n" +
	"\bCREATING\x10\x01\x12\n" +
	"\n" +
	...
	"\bDELETING\x10\x04\x12\n" +
	"\n" +
	"\x06FAILED\x10\x05\"\x84\x01\n" +
	"\x12ClusterIPOIBConfig\x12*\n" +
	"\x0enetwork_prefix\x18\x01 \x01(\tB\x03\xe0A\x02R\rnetworkPrefix\x12 \n" +
	"\tport_bits\x18\x02 \x01(\x05B\x03\xe0A\x02R\bportBits\x12 \n" +
	"\thost_bits\x18\x03 \x01(\x05B\x03\xe0A\x02R\bhostBits\"\xef\a\n" +
...
var file_svc_compute_baremetal_baremetal_proto_goTypes = []any{
	...
	(*ClusterIPOIBConfig)(nil),    // 9: org.cudo.compute.v1.ClusterIPOIBConfig
	...
	(sshkey.SshKeySource)(0),      // 14: org.cudo.compute.v1.SshKeySource
}
var file_svc_compute_baremetal_baremetal_proto_depIdxs = []int32{
	...
	13, // 7: org.cudo.compute.v1.Machine.create_time:type_name -> google.protobuf.Timestamp
	11, // 8: org.cudo.compute.v1.Machine.commitment_term:type_name -> org.cudo.compute.v1.CommitmentTerm
	12, // 9: org.cudo.compute.v1.Machine.price_hr:type_name -> google.type.Decimal
	14, // 10: org.cudo.compute.v1.Machine.ssh_key_source:type_name -> org.cudo.compute.v1.SshKeySource
	11, // 11: org.cudo.compute.v1.Cluster.commitment_term:type_name -> org.cudo.compute.v1.CommitmentTerm
	13, // 12: org.cudo.compute.v1.Cluster.commitment_end_time:type_name -> google.protobuf.Timestamp
	14, // 13: org.cudo.compute.v1.Cluster.ssh_key_source:type_name -> org.cudo.compute.v1.SshKeySource
	...
	12, // 16: org.cudo.compute.v1.Cluster.machine_price_hr:type_name -> google.type.Decimal
	12, // 17: org.cudo.compute.v1.Cluster.total_machine_price_hr:type_name -> google.type.Decimal
	12, // 18: org.cudo.compute.v1.Cluster.total_price_hr:type_name -> google.type.Decimal
	10, // 19: org.cudo.compute.v1.Cluster.machines:type_name -> org.cudo.compute.v1.ClusterMachine
	13, // 20: org.cudo.compute.v1.Cluster.create_time:type_name -> google.protobuf.Timestamp
	9,  // 21: org.cudo.compute.v1.Cluster.ipoib_config:type_name -> org.cudo.compute.v1.ClusterIPOIBConfig
	1,  // 22: org.cudo.compute.v1.ClusterMachine.power_state:type_name -> org.cudo.compute.v1.MachinePowerState
	4,  // 23: org.cudo.compute.v1.ClusterMachine.state:type_name -> org.cudo.compute.v1.ClusterMachine.State
	12, // 24: org.cudo.compute.v1.ClusterMachine.price_hr:type_name -> google.type.Decimal
	13, // 25: org.cudo.compute.v1.ClusterMachine.create_time:type_name -> google.protobuf.Timestamp
