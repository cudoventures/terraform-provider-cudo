...
const file_svc_compute_baremetal_baremetal_svc_proto_rawDesc = "" +
	"\n" +
	")svc/compute/baremetal/baremetal_svc.proto\x12\x13org.cudo.compute.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\x1a\x17svc/compute/types.proto\x1a%svc/compute/baremetal/baremetal.proto\"N\n" +
	"\x14CreateMachineRequest\x126\n" +
	"\amachine\x18\x01 \x01(\v2\x1c.org.cudo.compute.v1.MachineR\amachine\"O\n" +
	...
	"pageNumber\x12 \n" +
	"\tpage_size\x18\x04 \x01(\x05B\x03\xe0A\x02R\bpageSize\"\x8b\x01\n" +
	"\x14UpdateMachineRequest\x126\n" +
	"\amachine\x18\x01 \x01(\v2\x1c.org.cudo.compute.v1.MachineR\amachine\x12;\n" +
	...
	"\tuser_data\x18\x04 \x01(\tR\buserData\"m\n" +
	...
	"\x05force\x18\x03 \x01(\bR\x05force\"\xb2\x01\n" +
	...
	"\n" +
	"project_id\x18\x03 \x01(\tH\x02R\tprojectId\x88\x01\x01B\x0e\n" +
	"\f_page_numberB\f\n" +
	"\n" +
	"_page_sizeB\r\n" +
	"\v_project_id\"\xcf\x01\n" +
	...
	"\x06images\x18\x01 \x03(\v2\x1a.org.cudo.compute.v1.ImageB\x03\xe0A\x02R\x06images\"N\n" +
	"\x14CreateClusterRequest\x126\n" +
	"\acluster\x18\x01 \x01(\v2\x1c.org.cudo.compute.v1.ClusterR\acluster\"O\n" +
	...
	"\n" +
	"project_id\x18\x01 \x01(\tB\x03\xe0A\x02R\tprojectId\x12\x13\n" +
	"\x02id\x18\x02 \x01(\tB\x03\xe0A\x02R\x02id\"\xb9\x01\n" +
	...
	"\vpage_number\x18\x03 \x01(\x05B\x03\xe0A\x02R\n" +
	"pageNumber\x12 \n" +
	"\tpage_size\x18\x04 \x01(\x05B\x03\xe0A\x02R\bpageSize\"\x9f\x01\n" +
	...
	"pageNumber\x12 \n" +
	"\tpage_size\x18\x04 \x01(\x05B\x03\xe0A\x02R\bpageSize\"\x8b\x01\n" +
	"\x14UpdateClusterRequest\x126\n" +
	"\acluster\x18\x01 \x01(\v2\x1c.org.cudo.compute.v1.ClusterR\acluster\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"\xa8\x01\n" +
	"\x1bUpdateClusterMachineRequest\x12L\n" +
	"\x0fcluster_machine\x18\x01 \x01(\v2#.org.cudo.compute.v1.ClusterMachineR\x0eclusterMachine\x12;\n" +
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"V\n" +
	...
	"\n" +
	"project_id\x18\x01 \x01(\tB\x03\xe0A\x02R\tprojectId\x12\x13\n" +
	"\x02id\x18\x02 \x01(\tB\x03\xe0A\x02R\x02id2\x83\x1a\n" +
	"\x10BareMetalService\x12\x95\x01\n" +
	"\rCreateMachine\x12).org.cudo.compute.v1.CreateMachineRequest\x1a\x1c.org.cudo.compute.v1.Machine\";\x82\xd3\xe4\x93\x025:\amachine\"*/v1/projects/{machine.project_id}/machines\x12\x83\x01\n" +
	"\rDeleteMachine\x12).org.cudo.compute.v1.DeleteMachineRequest\x1a\x16.google.protobuf.Empty\"/\x82\xd3\xe4\x93\x02)*'/v1/projects/{project_id}/machines/{id}\x12\x83\x01\n" +
	"\n" +
	"GetMachine\x12&.org.cudo.compute.v1.GetMachineRequest\x1a\x1c.org.cudo.compute.v1.Machine\"/\x82\xd3\xe4\x93\x02)\x12'/v1/projects/{project_id}/machines/{id}\x12\x8f\x01\n" +
	"\fListMachines\x12(.org.cudo.compute.v1.ListMachinesRequest\x1a).org.cudo.compute.v1.ListMachinesResponse\"*\x82\xd3\xe4\x93\x02$\x12\"/v1/projects/{project_id}/machines\x12\xa2\x01\n" +
	"\rUpdateMachine\x12).org.cudo.compute.v1.UpdateMachineRequest\x1a\x1c.org.cudo.compute.v1.Machine\"H\x82\xd3\xe4\x93\x02B:\amachine27/v1/projects/{machine.project_id}/machines/{machine.id}\x12\x91\x01\n" +
	"\x0fPowerOffMachine\x12+.org.cudo.compute.v1.PowerOffMachineRequest\x1a\x16.google.protobuf.Empty\"9\x82\xd3\xe4\x93\x023\"1/v1/projects/{project_id}/machines/{id}/power-off\x12\x8e\x01\n" +
	"\x0ePowerOnMachine\x12*.org.cudo.compute.v1.PowerOnMachineRequest\x1a\x16.google.protobuf.Empty\"8\x82\xd3\xe4\x93\x022\"0/v1/projects/{project_id}/machines/{id}/power-on\x12\x8e\x01\n" +
	"\x0fDeployMachineOS\x12+.org.cudo.compute.v1.DeployMachineOSRequest\x1a\x16.google.protobuf.Empty\"6\x82\xd3\xe4\x93\x020\"./v1/projects/{project_id}/machines/{id}/deploy\x12\xb8\x01\n" +
	"\x1bListMachineOperatingSystems\x127.org.cudo.compute.v1.ListMachineOperatingSystemsRequest\x1a8.org.cudo.compute.v1.ListMachineOperatingSystemsResponse\"&\x82\xd3\xe4\x93\x02 \x12\x1e/v1/machines/operating-systems\x12\x8b\x01\n" +
	"\x10ListMachineTypes\x12,.org.cudo.compute.v1.ListMachineTypesRequest\x1a-.org.cudo.compute.v1.ListMachineTypesResponse\"\x1a\x82\xd3\xe4\x93\x02\x14\x12\x12/v1/machines-types\x12\xa8\x01\n" +
	"\x17ListClusterMachineTypes\x123.org.cudo.compute.v1.ListClusterMachineTypesRequest\x1a4.org.cudo.compute.v1.ListClusterMachineTypesResponse\"\"\x82\xd3\xe4\x93\x02\x1c\x12\x1a/v1/clusters/machine-types\x12\xd2\x01\n" +
	"\x15GetClusterMachineType\x121.org.cudo.compute.v1.GetClusterMachineTypeRequest\x1a2.org.cudo.compute.v1.GetClusterMachineTypeResponse\"R\x82\xd3\xe4\x93\x02L\x12J/v1/clusters/data-centers/{data_center_id}/machine-types/{machine_type_id}\x12\x95\x01\n" +
	"\rCreateCluster\x12).org.cudo.compute.v1.CreateClusterRequest\x1a\x1c.org.cudo.compute.v1.Cluster\";\x82\xd3\xe4\x93\x025:\acluster\"*/v1/projects/{cluster.project_id}/clusters\x12\x83\x01\n" +
	"\rDeleteCluster\x12).org.cudo.compute.v1.DeleteClusterRequest\x1a\x16.google.protobuf.Empty\"/\x82\xd3\xe4\x93\x02)*'/v1/projects/{project_id}/clusters/{id}\x12\x83\x01\n" +
	"\n" +
	"GetCluster\x12&.org.cudo.compute.v1.GetClusterRequest\x1a\x1c.org.cudo.compute.v1.Cluster\"/\x82\xd3\xe4\x93\x02)\x12'/v1/projects/{project_id}/clusters/{id}\x12\x8f\x01\n" +
	"\fListClusters\x12(.org.cudo.compute.v1.ListClustersRequest\x1a).org.cudo.compute.v1.ListClustersResponse\"*\x82\xd3\xe4\x93\x02$\x12\"/v1/projects/{project_id}/clusters\x12\xa2\x01\n" +
	"\rUpdateCluster\x12).org.cudo.compute.v1.UpdateClusterRequest\x1a\x1c.org.cudo.compute.v1.Cluster\"H\x82\xd3\xe4\x93\x02B:\acluster27/v1/projects/{cluster.project_id}/clusters/{cluster.id}\x12\x99\x01\n" +
	"\x14DeleteClusterMachine\x120.org.cudo.compute.v1.DeleteClusterMachineRequest\x1a\x16.google.protobuf.Empty\"7\x82\xd3\xe4\x93\x021*//v1/projects/{project_id}/cluster-machines/{id}\x12\xa0\x01\n" +
	"\x14RebootClusterMachine\x120.org.cudo.compute.v1.RebootClusterMachineRequest\x1a\x16.google.protobuf.Empty\">\x82\xd3\xe4\x93\x028\"6/v1/projects/{project_id}/cluster-machines/{id}:reboot\x12\xa0\x01\n" +
	"\x14RenameClusterMachine\x120.org.cudo.compute.v1.RenameClusterMachineRequest\x1a\x16.google.protobuf.Empty\">\x82\xd3\xe4\x93\x028\"6/v1/projects/{project_id}/cluster-machines/{id}:rename\x12\xd7\x01\n" +
	"\x14UpdateClusterMachine\x120.org.cudo.compute.v1.UpdateClusterMachineRequest\x1a#.org.cudo.compute.v1.ClusterMachine\"h\x82\xd3\xe4\x93\x02b:\x0fcluster_machine2O/v1/projects/{cluster_machine.project_id}/cluster-machines/{cluster_machine.id}BLZJgithub.com/CudoVentures/terraform-provider-cudo/internal/compute/baremetalb\x06proto3"
...
var file_svc_compute_baremetal_baremetal_svc_proto_goTypes = []any{
	...
	(*PowerOnMachineRequest)(nil),               // 7: org.cudo.compute.v1.PowerOnMachineRequest
	(*PowerOffMachineRequest)(nil),              // 8: org.cudo.compute.v1.PowerOffMachineRequest
	(*ListMachineTypesRequest)(nil),             // 9: org.cudo.compute.v1.ListMachineTypesRequest
	(*ListMachineTypesResponse)(nil),            // 10: org.cudo.compute.v1.ListMachineTypesResponse
	(*ListMachineOperatingSystemsRequest)(nil),  // 11: org.cudo.compute.v1.ListMachineOperatingSystemsRequest
	(*ListMachineOperatingSystemsResponse)(nil), // 12: org.cudo.compute.v1.ListMachineOperatingSystemsResponse
	(*CreateClusterRequest)(nil),                // 13: org.cudo.compute.v1.CreateClusterRequest
	(*DeleteClusterRequest)(nil),                // 14: org.cudo.compute.v1.DeleteClusterRequest
	(*GetClusterMachineTypeRequest)(nil),        // 15: org.cudo.compute.v1.GetClusterMachineTypeRequest
	(*GetClusterMachineTypeResponse)(nil),       // 16: org.cudo.compute.v1.GetClusterMachineTypeResponse
	(*GetClusterRequest)(nil),                   // 17: org.cudo.compute.v1.GetClusterRequest
	(*ListClusterMachineTypesRequest)(nil),      // 18: org.cudo.compute.v1.ListClusterMachineTypesRequest
	(*ListClusterMachineTypesResponse)(nil),     // 19: org.cudo.compute.v1.ListClusterMachineTypesResponse
	(*ListClustersRequest)(nil),                 // 20: org.cudo.compute.v1.ListClustersRequest
	(*ListClustersResponse)(nil),                // 21: org.cudo.compute.v1.ListClustersResponse
	(*UpdateClusterRequest)(nil),                // 22: org.cudo.compute.v1.UpdateClusterRequest
	(*UpdateClusterMachineRequest)(nil),         // 23: org.cudo.compute.v1.UpdateClusterMachineRequest
	(*RebootClusterMachineRequest)(nil),         // 24: org.cudo.compute.v1.RebootClusterMachineRequest
	(*RenameClusterMachineRequest)(nil),         // 25: org.cudo.compute.v1.RenameClusterMachineRequest
	(*DeleteClusterMachineRequest)(nil),         // 26: org.cudo.compute.v1.DeleteClusterMachineRequest
	(*Machine)(nil),                             // 27: org.cudo.compute.v1.Machine
	(*fieldmaskpb.FieldMask)(nil),               // 28: google.protobuf.FieldMask
	(*MachineType)(nil),                         // 29: org.cudo.compute.v1.MachineType
	(*compute.Image)(nil),                       // 30: org.cudo.compute.v1.Image
	(*Cluster)(nil),                             // 31: org.cudo.compute.v1.Cluster
	(*ClusterMachine)(nil),                      // 32: org.cudo.compute.v1.ClusterMachine
	(*emptypb.Empty)(nil),                       // 33: google.protobuf.Empty
}
var file_svc_compute_baremetal_baremetal_svc_proto_depIdxs = []int32{
	27, // 0: org.cudo.compute.v1.CreateMachineRequest.machine:type_name -> org.cudo.compute.v1.Machine
	27, // 1: org.cudo.compute.v1.ListMachinesResponse.machines:type_name -> org.cudo.compute.v1.Machine
	27, // 2: org.cudo.compute.v1.UpdateMachineRequest.machine:type_name -> org.cudo.compute.v1.Machine
	28, // 3: org.cudo.compute.v1.UpdateMachineRequest.update_mask:type_name -> google.protobuf.FieldMask
	29, // 4: org.cudo.compute.v1.ListMachineTypesResponse.machine_types:type_name -> org.cudo.compute.v1.MachineType
	30, // 5: org.cudo.compute.v1.ListMachineOperatingSystemsResponse.images:type_name -> org.cudo.compute.v1.Image
	31, // 6: org.cudo.compute.v1.CreateClusterRequest.cluster:type_name -> org.cudo.compute.v1.Cluster
	29, // 7: org.cudo.compute.v1.GetClusterMachineTypeResponse.machine_type:type_name -> org.cudo.compute.v1.MachineType
	29, // 8: org.cudo.compute.v1.ListClusterMachineTypesResponse.machine_types:type_name -> org.cudo.compute.v1.MachineType
	31, // 9: org.cudo.compute.v1.ListClustersResponse.clusters:type_name -> org.cudo.compute.v1.Cluster
	31, // 10: org.cudo.compute.v1.UpdateClusterRequest.cluster:type_name -> org.cudo.compute.v1.Cluster
	28, // 11: org.cudo.compute.v1.UpdateClusterRequest.update_mask:type_name -> google.protobuf.FieldMask
	32, // 12: org.cudo.compute.v1.UpdateClusterMachineRequest.cluster_machine:type_name -> org.cudo.compute.v1.ClusterMachine
	28, // 13: org.cudo.compute.v1.UpdateClusterMachineRequest.update_mask:type_name -> google.protobuf.FieldMask
	...
	8,  // 19: org.cudo.compute.v1.BareMetalService.PowerOffMachine:input_type -> org.cudo.compute.v1.PowerOffMachineRequest
	7,  // 20: org.cudo.compute.v1.BareMetalService.PowerOnMachine:input_type -> org.cudo.compute.v1.PowerOnMachineRequest
	6,  // 21: org.cudo.compute.v1.BareMetalService.DeployMachineOS:input_type -> org.cudo.compute.v1.DeployMachineOSRequest
	11, // 22: org.cudo.compute.v1.BareMetalService.ListMachineOperatingSystems:input_type -> org.cudo.compute.v1.ListMachineOperatingSystemsRequest
	9,  // 23: org.cudo.compute.v1.BareMetalService.ListMachineTypes:input_type -> org.cudo.compute.v1.ListMachineTypesRequest
	18, // 24: org.cudo.compute.v1.BareMetalService.ListClusterMachineTypes:input_type -> org.cudo.compute.v1.ListClusterMachineTypesRequest
	15, // 25: org.cudo.compute.v1.BareMetalService.GetClusterMachineType:input_type -> org.cudo.compute.v1.GetClusterMachineTypeRequest
	13, // 26: org.cudo.compute.v1.BareMetalService.CreateCluster:input_type -> org.cudo.compute.v1.CreateClusterRequest
	14, // 27: org.cudo.compute.v1.BareMetalService.DeleteCluster:input_type -> org.cudo.compute.v1.DeleteClusterRequest
	17, // 28: org.cudo.compute.v1.BareMetalService.GetCluster:input_type -> org.cudo.compute.v1.GetClusterRequest
	20, // 29: org.cudo.compute.v1.BareMetalService.ListClusters:input_type -> org.cudo.compute.v1.ListClustersRequest
	22, // 30: org.cudo.compute.v1.BareMetalService.UpdateCluster:input_type -> org.cudo.compute.v1.UpdateClusterRequest
	26, // 31: org.cudo.compute.v1.BareMetalService.DeleteClusterMachine:input_type -> org.cudo.compute.v1.DeleteClusterMachineRequest
	24, // 32: org.cudo.compute.v1.BareMetalService.RebootClusterMachine:input_type -> org.cudo.compute.v1.RebootClusterMachineRequest
	25, // 33: org.cudo.compute.v1.BareMetalService.RenameClusterMachine:input_type -> org.cudo.compute.v1.RenameClusterMachineRequest
	23, // 34: org.cudo.compute.v1.BareMetalService.UpdateClusterMachine:input_type -> org.cudo.compute.v1.UpdateClusterMachineRequest
	27, // 35: org.cudo.compute.v1.BareMetalService.CreateMachine:output_type -> org.cudo.compute.v1.Machine
	33, // 36: org.cudo.compute.v1.BareMetalService.DeleteMachine:output_type -> google.protobuf.Empty
	27, // 37: org.cudo.compute.v1.BareMetalService.GetMachine:output_type -> org.cudo.compute.v1.Machine
	4,  // 38: org.cudo.compute.v1.BareMetalService.ListMachines:output_type -> org.cudo.compute.v1.ListMachinesResponse
	27, // 39: org.cudo.compute.v1.BareMetalService.UpdateMachine:output_type -> org.cudo.compute.v1.Machine
	33, // 40: org.cudo.compute.v1.BareMetalService.PowerOffMachine:output_type -> google.protobuf.Empty
	33, // 41: org.cudo.compute.v1.BareMetalService.PowerOnMachine:output_type -> google.protobuf.Empty
	33, // 42: org.cudo.compute.v1.BareMetalService.DeployMachineOS:output_type -> google.protobuf.Empty
	12, // 43: org.cudo.compute.v1.BareMetalService.ListMachineOperatingSystems:output_type -> org.cudo.compute.v1.ListMachineOperatingSystemsResponse
	10, // 44: org.cudo.compute.v1.BareMetalService.ListMachineTypes:output_type -> org.cudo.compute.v1.ListMachineTypesResponse
	19, // 45: org.cudo.compute.v1.BareMetalService.ListClusterMachineTypes:output_type -> org.cudo.compute.v1.ListClusterMachineTypesResponse
	16, // 46: org.cudo.compute.v1.BareMetalService.GetClusterMachineType:output_type -> org.cudo.compute.v1.GetClusterMachineTypeResponse
	31, // 47: org.cudo.compute.v1.BareMetalService.CreateCluster:output_type -> org.cudo.compute.v1.Cluster
	33, // 48: org.cudo.compute.v1.BareMetalService.DeleteCluster:output_type -> google.protobuf.Empty
	31, // 49: org.cudo.compute.v1.BareMetalService.GetCluster:output_type -> org.cudo.compute.v1.Cluster
	21, // 50: org.cudo.compute.v1.BareMetalService.ListClusters:output_type -> org.cudo.compute.v1.ListClustersResponse
	31, // 51: org.cudo.compute.v1.BareMetalService.UpdateCluster:output_type -> org.cudo.compute.v1.Cluster
	33, // 52: org.cudo.compute.v1.BareMetalService.DeleteClusterMachine:output_type -> google.protobuf.Empty
	33, // 53: org.cudo.compute.v1.BareMetalService.RebootClusterMachine:output_type -> google.protobuf.Empty
	33, // 54: org.cudo.compute.v1.BareMetalService.RenameClusterMachine:output_type -> google.protobuf.Empty
	32, // 55: org.cudo.compute.v1.BareMetalService.UpdateClusterMachine:output_type -> org.cudo.compute.v1.ClusterMachine
...
func file_svc_compute_baremetal_baremetal_svc_proto_init() {
	...
	file_svc_compute_baremetal_baremetal_svc_proto_msgTypes[3].OneofWrappers = []any{}
	file_svc_compute_baremetal_baremetal_svc_proto_msgTypes[9].OneofWrappers = []any{}
	file_svc_compute_baremetal_baremetal_svc_proto_msgTypes[15].OneofWrappers = []any{}
	file_svc_compute_baremetal_baremetal_svc_proto_msgTypes[18].OneofWrappers = []any{}
	file_svc_compute_baremetal_baremetal_svc_proto_msgTypes[20].OneofWrappers = []any{}
	type x struct{}
