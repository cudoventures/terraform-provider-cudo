...
const file_svc_compute_baremetal_baremetal_svc_proto_rawDesc = "" +
	"\n" +
	")svc/compute/baremetal/baremetal_svc.proto\x12\x13org.cudo.compute.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\x1a$gnostic/openapi/v3/annotations.proto\x1a\x17svc/compute/types.proto\x1a%svc/compute/baremetal/baremetal.proto\"N\n" +
	...
	"\n" +
	"project_id\x18\x01 \x01(\tB\x03\xe0A\x02R\tprojectId\x12\x13\n" +
	"\x02id\x18\x02 \x01(\tB\x03\xe0A\x02R\x02id2\x9c*\n" +
	"\x10BareMetalService\x12\xe3\x01\n" +
	"\rCreateMachine\x12).org.cudo.compute.v1.CreateMachineRequest\x1a\x1c.org.cudo.compute.v1.Machine\"\x88\x01\xbaGJ\n" +
	"\bMachines\x12\x10Create a machine\x1a\x1dOrder a machine for a project*\rCreateMachine\x82\xd3\xe4\x93\x025:\amachine\"*/v1/projects/{machine.project_id}/machines\x12\x99\x02\n" +
	"\rDeleteMachine\x12).org.cudo.compute.v1.DeleteMachineRequest\x1a\x16.google.protobuf.Empty\"\xc4\x01\xbaG\x91\x01\n" +
	"\bMachines\x12\x10Delete a machine\x1adDelete a machine from a project. Machines that are still within a commitment term cannot be deleted.*\rDeleteMachine\x82\xd3\xe4\x93\x02)*'/v1/projects/{project_id}/machines/{id}\x12\xc9\x01\n" +
	"\n" +
	"GetMachine\x12&.org.cudo.compute.v1.GetMachineRequest\x1a\x1c.org.cudo.compute.v1.Machine\"u\xbaGC\n" +
	"\bMachines\x12\rGet a machine\x1a\x1cGet the details of a machine*\n" +
	"GetMachine\x82\xd3\xe4\x93\x02)\x12'/v1/projects/{project_id}/machines/{id}\x12\xd5\x01\n" +
	"\fListMachines\x12(.org.cudo.compute.v1.ListMachinesRequest\x1a).org.cudo.compute.v1.ListMachinesResponse\"p\xbaGC\n" +
	"\bMachines\x12\rList machines\x1a\x1aList machines in a project*\fListMachines\x82\xd3\xe4\x93\x02$\x12\"/v1/projects/{project_id}/machines\x12\xf0\x01\n" +
	"\rUpdateMachine\x12).org.cudo.compute.v1.UpdateMachineRequest\x1a\x1c.org.cudo.compute.v1.Machine\"\x95\x01\xbaGJ\n" +
	"\bMachines\x12\x10Update a machine\x1a\x1dUpdate a machine in a project*\rUpdateMachine\x82\xd3\xe4\x93\x02B:\amachine27/v1/projects/{machine.project_id}/machines/{machine.id}\x12\xe8\x01\n" +
	"\x0fPowerOffMachine\x12+.org.cudo.compute.v1.PowerOffMachineRequest\x1a\x16.google.protobuf.Empty\"\x8f\x01\xbaGS\n" +
	"\bMachines\x12\x14Power off a machine \x1a Power off a machine in a project*\x0fPowerOffMachine\x82\xd3\xe4\x93\x023\"1/v1/projects/{project_id}/machines/{id}/power-off\x12\xe1\x01\n" +
	"\x0ePowerOnMachine\x12*.org.cudo.compute.v1.PowerOnMachineRequest\x1a\x16.google.protobuf.Empty\"\x8a\x01\xbaGO\n" +
	"\bMachines\x12\x12Power on a machine\x1a\x1fPower on a machine in a project*\x0ePowerOnMachine\x82\xd3\xe4\x93\x022\"0/v1/projects/{project_id}/machines/{id}/power-on\x12\xf1\x01\n" +
	"\x0fDeployMachineOS\x12+.org.cudo.compute.v1.DeployMachineOSRequest\x1a\x16.google.protobuf.Empty\"\x98\x01\xbaG_\n" +
	"\bMachines\x12\x17Deploy operating system\x1a)Deploy an operating system onto a machine*\x0fDeployMachineOS\x82\xd3\xe4\x93\x020\"./v1/projects/{project_id}/machines/{id}/deploy\x12\x85\x02\n" +
	"\x11UndeployMachineOS\x12-.org.cudo.compute.v1.UndeployMachineOSRequest\x1a\x16.google.protobuf.Empty\"\xa8\x01\xbaGm\n" +
	"\bMachines\x12\x0fRelease machine\x1a=Releases a machine allowing subsequent deployment of a new OS*\x11UndeployMachineOS\x82\xd3\xe4\x93\x022\"0/v1/projects/{project_id}/machines/{id}/undeploy\x12\xb4\x02\n" +
	"\x1bListMachineOperatingSystems\x127.org.cudo.compute.v1.ListMachineOperatingSystemsRequest\x1a8.org.cudo.compute.v1.ListMachineOperatingSystemsResponse\"\xa1\x01\xbaGx\n" +
	"\bMachines\x12\x16List operating systems\x1a7List operating systems that can be deployed to machines*\x1bListMachineOperatingSystems\x82\xd3\xe4\x93\x02 \x12\x1e/v1/machines/operating-systems\x12\xe6\x01\n" +
	"\x10ListMachineTypes\x12,.org.cudo.compute.v1.ListMachineTypesRequest\x1a-.org.cudo.compute.v1.ListMachineTypesResponse\"u\xbaGX\n" +
	"\bMachines\x12\x12List machine types\x1a&List machine types that can be ordered*\x10ListMachineTypes\x82\xd3\xe4\x93\x02\x14\x12\x12/v1/machines-types\x12\xea\x01\n" +
	"\x17ListClusterMachineTypes\x123.org.cudo.compute.v1.ListClusterMachineTypesRequest\x1a4.org.cudo.compute.v1.ListClusterMachineTypesResponse\"d\xbaG?\n" +
	"\bClusters\x12\x1aList cluster machine types*\x17ListClusterMachineTypes\x82\xd3\xe4\x93\x02\x1c\x12\x1a/v1/clusters/machine-types\x12\x91\x02\n" +
	"\x15GetClusterMachineType\x121.org.cudo.compute.v1.GetClusterMachineTypeRequest\x1a2.org.cudo.compute.v1.GetClusterMachineTypeResponse\"\x90\x01\xbaG;\n" +
	"\bClusters\x12\x18Get cluster machine type*\x15GetClusterMachineType\x82\xd3\xe4\x93\x02L\x12J/v1/clusters/data-centers/{data_center_id}/machine-types/{machine_type_id}\x12\xe3\x01\n" +
	"\rCreateCluster\x12).org.cudo.compute.v1.CreateClusterRequest\x1a\x1c.org.cudo.compute.v1.Cluster\"\x88\x01\xbaGJ\n" +
	"\bClusters\x12\x10Create a cluster\x1a\x1dOrder a cluster for a project*\rCreateCluster\x82\xd3\xe4\x93\x025:\acluster\"*/v1/projects/{cluster.project_id}/clusters\x12\xd3\x01\n" +
	"\rDeleteCluster\x12).org.cudo.compute.v1.DeleteClusterRequest\x1a\x16.google.protobuf.Empty\"\x7f\xbaGM\n" +
	"\bClusters\x12\x10Delete a cluster\x1a Delete a cluster from a project.*\rDeleteCluster\x82\xd3\xe4\x93\x02)*'/v1/projects/{project_id}/clusters/{id}\x12\xc9\x01\n" +
	"\n" +
	"GetCluster\x12&.org.cudo.compute.v1.GetClusterRequest\x1a\x1c.org.cudo.compute.v1.Cluster\"u\xbaGC\n" +
	"\bClusters\x12\rGet a cluster\x1a\x1cGet the details of a cluster*\n" +
	"GetCluster\x82\xd3\xe4\x93\x02)\x12'/v1/projects/{project_id}/clusters/{id}\x12\xd5\x01\n" +
	"\fListClusters\x12(.org.cudo.compute.v1.ListClustersRequest\x1a).org.cudo.compute.v1.ListClustersResponse\"p\xbaGC\n" +
	"\bClusters\x12\rList clusters\x1a\x1aList clusters in a project*\fListClusters\x82\xd3\xe4\x93\x02$\x12\"/v1/projects/{project_id}/clusters\x12\xf0\x01\n" +
	"\rUpdateCluster\x12).org.cudo.compute.v1.UpdateClusterRequest\x1a\x1c.org.cudo.compute.v1.Cluster\"\x95\x01\xbaGJ\n" +
	"\bClusters\x12\x10Update a cluster\x1a\x1dUpdate a cluster in a project*\rUpdateCluster\x82\xd3\xe4\x93\x02B:\acluster27/v1/projects/{cluster.project_id}/clusters/{cluster.id}\x12\xf8\x01\n" +
	"\x14DeleteClusterMachine\x120.org.cudo.compute.v1.DeleteClusterMachineRequest\x1a\x16.google.protobuf.Empty\"\x95\x01\xbaG[\n" +
	"\bClusters\x12\x18Delete a cluster machine\x1a\x1fDelete a machine from a cluster*\x14DeleteClusterMachine\x82\xd3\xe4\x93\x021*//v1/projects/{project_id}/cluster-machines/{id}\x12\xfd\x01\n" +
	"\x14RebootClusterMachine\x120.org.cudo.compute.v1.RebootClusterMachineRequest\x1a\x16.google.protobuf.Empty\"\x9a\x01\xbaGY\n" +
	"\bClusters\x12\x18Reboot a cluster machine\x1a\x1dReboot a machine in a cluster*\x14RebootClusterMachine\x82\xd3\xe4\x93\x028\"6/v1/projects/{project_id}/cluster-machines/{id}:reboot\x12\xfd\x01\n" +
	"\x14RenameClusterMachine\x120.org.cudo.compute.v1.RenameClusterMachineRequest\x1a\x16.google.protobuf.Empty\"\x9a\x01\xbaGY\n" +
	"\bClusters\x12\x18Rename a cluster machine\x1a\x1dRename a machine in a cluster*\x14RenameClusterMachine\x82\xd3\xe4\x93\x028\"6/v1/projects/{project_id}/cluster-machines/{id}:rename\x12\xb4\x02\n" +
	"\x14UpdateClusterMachine\x120.org.cudo.compute.v1.UpdateClusterMachineRequest\x1a#.org.cudo.compute.v1.ClusterMachine\"\xc4\x01\xbaGY\n" +
	"\bClusters\x12\x18Update a cluster machine\x1a\x1dUpdate a machine in a cluster*\x14UpdateClusterMachine\x82\xd3\xe4\x93\x02b:\x0fcluster_machine2O/v1/projects/{cluster_machine.project_id}/cluster-machines/{cluster_machine.id}BLZJgithub.com/CudoVentures/terraform-provider-cudo/internal/compute/baremetalb\x06proto3"
