...
func (Disk_DiskType) EnumDescriptor() ([]byte, []int) {
	return file_svc_compute_vm_vm_proto_rawDescGZIP(), []int{4, 0}
}
...
func (Disk_DiskState) EnumDescriptor() ([]byte, []int) {
	return file_svc_compute_vm_vm_proto_rawDescGZIP(), []int{4, 1}
}
...
//
// Deprecated: Marked as deprecated in svc/compute/vm/vm.proto.
...
func (x *BootDisk) GetSizeGib() int32 {
	if x != nil {
		return x.SizeGib
	}
	return 0
...
type VirtualMachineTypePrice struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
...
func (x *VirtualMachineTypePrice) Reset() {
	*x = VirtualMachineTypePrice{}
	mi := &file_svc_compute_vm_vm_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *VirtualMachineTypePrice) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VirtualMachineTypePrice) ProtoMessage() {}

func (x *VirtualMachineTypePrice) ProtoReflect() protoreflect.Message {
	mi := &file_svc_compute_vm_vm_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VirtualMachineTypePrice.ProtoReflect.Descriptor instead.
func (*VirtualMachineTypePrice) Descriptor() ([]byte, []int) {
	return file_svc_compute_vm_vm_proto_rawDescGZIP(), []int{5}
}

func (x *VirtualMachineTypePrice) GetVcpuPriceHr() *decimal.Decimal {
	if x != nil {
...
func (x *VirtualMachineTypePrice) GetMemoryGibPriceHr() *decimal.Decimal {
	if x != nil {
...
func (x *VirtualMachineTypePrice) GetGpuPriceHr() *decimal.Decimal {
	if x != nil {
		return x.GpuPriceHr
	}
	return nil
...
func (x *VirtualMachineTypePrice) GetCommitmentTerm() compute.CommitmentTerm {
	if x != nil {
		return x.CommitmentTerm
	}
	return compute.CommitmentTerm(0)
...
const file_svc_compute_vm_vm_proto_rawDesc = "" +
	"\n" +
	"\x17svc/compute/vm/vm.proto\x12\x13org.cudo.compute.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x19google/type/decimal.proto\x1a-svc/compute/securitygroup/securitygroup.proto\x1a\x1fsvc/compute/sshkey/sshkey.proto\x1a\x17svc/compute/types.proto\"\x91\x1c\n" +
	"\x02VM\x12(\n" +
	...
	"expireTime\x12:\n" +
	"\x05price\x18! \x01(\v2\x1f.org.cudo.compute.v1.VM.VMPriceB\x03\xe0A\x03R\x05price\x12Q\n" +
	"\x0fcommitment_term\x18\" \x01(\x0e2#.org.cudo.compute.v1.CommitmentTermB\x03\xe0A\x02R\x0ecommitmentTerm\x12O\n" +
	"\x13commitment_end_time\x18# \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\x11commitmentEndTime\x12G\n" +
	...
	"\bUPDATING\x10\b\".\n" +
	"\bBootDisk\x12\x1e\n" +
	"\bsize_gib\x18\x05 \x01(\x05B\x03\xe0A\x02R\asizeGib:\x02\x18\x01\"\xa4\x05\n" +
	"\x04Disk\x12\x13\n" +
	...
	"\bsize_gib\x18\x05 \x01(\x05B\x03\xe0A\x02R\asizeGib\x12D\n" +
	...
	"createTime\x12G\n" +
	"\n" +
	"disk_state\x18\v \x01(\x0e2#.org.cudo.compute.v1.Disk.DiskStateB\x03\xe0A\x03R\tdiskState\"L\n" +
	"\bDiskType\x12\x15\n" +
	...
	"\x06FAILED\x10\x06\x12\t\n" +
	"\x05READY\x10\a\x12\f\n" +
	"\bUPDATING\x10\b\"\xb2\x02\n" +
	"\x17VirtualMachineTypePrice\x12=\n" +
	"\rvcpu_price_hr\x18\x01 \x01(\v2\x14.google.type.DecimalB\x03\xe0A\x02R\vvcpuPriceHr\x12H\n" +
	...
	"gpuPriceHr\x12Q\n" +
	"\x0fcommitment_term\x18\x04 \x01(\x0e2#.org.cudo.compute.v1.CommitmentTermB\x03\xe0A\x02R\x0ecommitmentTerm*\xa9\x03\n" +
...
var file_svc_compute_vm_vm_proto_enumTypes = make([]protoimpl.EnumInfo, 7)
var file_svc_compute_vm_vm_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_svc_compute_vm_vm_proto_goTypes = []any{
	...
	(Disk_DiskType)(0),                  // 5: org.cudo.compute.v1.Disk.DiskType
	(Disk_DiskState)(0),                 // 6: org.cudo.compute.v1.Disk.DiskState
	(*VM)(nil),                          // 7: org.cudo.compute.v1.VM
	(*VMMonitoringItem)(nil),            // 8: org.cudo.compute.v1.VMMonitoringItem
	(*PrivateImage)(nil),                // 9: org.cudo.compute.v1.PrivateImage
	(*BootDisk)(nil),                    // 10: org.cudo.compute.v1.BootDisk
	(*Disk)(nil),                        // 11: org.cudo.compute.v1.Disk
	(*VirtualMachineTypePrice)(nil),     // 12: org.cudo.compute.v1.VirtualMachineTypePrice
	...
	(sshkey.SshKeySource)(0),            // 19: org.cudo.compute.v1.SshKeySource
	(*securitygroup.SecurityGroup)(nil), // 20: org.cudo.compute.v1.SecurityGroup
...
var file_svc_compute_vm_vm_proto_depIdxs = []int32{
	...
	19, // 11: org.cudo.compute.v1.VM.ssh_key_source:type_name -> org.cudo.compute.v1.SshKeySource
	...
	5,  // 14: org.cudo.compute.v1.Disk.disk_type:type_name -> org.cudo.compute.v1.Disk.DiskType
	17, // 15: org.cudo.compute.v1.Disk.create_time:type_name -> google.protobuf.Timestamp
	6,  // 16: org.cudo.compute.v1.Disk.disk_state:type_name -> org.cudo.compute.v1.Disk.DiskState
	21, // 17: org.cudo.compute.v1.VirtualMachineTypePrice.vcpu_price_hr:type_name -> google.type.Decimal
	21, // 18: org.cudo.compute.v1.VirtualMachineTypePrice.memory_gib_price_hr:type_name -> google.type.Decimal
	21, // 19: org.cudo.compute.v1.VirtualMachineTypePrice.gpu_price_hr:type_name -> google.type.Decimal
	18, // 20: org.cudo.compute.v1.VirtualMachineTypePrice.commitment_term:type_name -> org.cudo.compute.v1.CommitmentTerm
	2,  // 21: org.cudo.compute.v1.VM.SecurityGroupRule.protocol:type_name -> org.cudo.compute.v1.VM.SecurityGroupRule.Protocol
	3,  // 22: org.cudo.compute.v1.VM.SecurityGroupRule.rule_type:type_name -> org.cudo.compute.v1.VM.SecurityGroupRule.RuleType
	21, // 23: org.cudo.compute.v1.VM.VMPrice.vcpu_price_hr:type_name -> google.type.Decimal
	21, // 24: org.cudo.compute.v1.VM.VMPrice.total_vcpu_price_hr:type_name -> google.type.Decimal
	21, // 25: org.cudo.compute.v1.VM.VMPrice.memory_gib_price_hr:type_name -> google.type.Decimal
	21, // 26: org.cudo.compute.v1.VM.VMPrice.total_memory_price_hr:type_name -> google.type.Decimal
	21, // 27: org.cudo.compute.v1.VM.VMPrice.gpu_price_hr:type_name -> google.type.Decimal
	21, // 28: org.cudo.compute.v1.VM.VMPrice.total_gpu_price_hr:type_name -> google.type.Decimal
	21, // 29: org.cudo.compute.v1.VM.VMPrice.storage_gib_price_hr:type_name -> google.type.Decimal
	21, // 30: org.cudo.compute.v1.VM.VMPrice.total_storage_price_hr:type_name -> google.type.Decimal
	21, // 31: org.cudo.compute.v1.VM.VMPrice.ipv4_address_price_hr:type_name -> google.type.Decimal
	21, // 32: org.cudo.compute.v1.VM.VMPrice.total_price_hr:type_name -> google.type.Decimal
