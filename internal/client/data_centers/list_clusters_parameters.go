...
// WithDataCenterID adds the dataCenterID to the list clusters params
func (o *ListClustersParams) WithDataCenterID(dataCenterID string) *ListClustersParams {
	o.SetDataCenterID(dataCenterID)
	return o
}

// SetDataCenterID adds the dataCenterId to the list clusters params
func (o *ListClustersParams) SetDataCenterID(dataCenterID string) {
