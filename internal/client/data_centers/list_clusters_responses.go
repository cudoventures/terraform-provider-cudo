...
func (o *ListClustersOK) Error() string {
	return fmt.Sprintf("[GET /v1/data-centers/{dataCenterId}/clusters][%d] listClustersOK  %+v", 200, o.Payload)
}
...
func (o *ListClustersDefault) Error() string {
	return fmt.Sprintf("[GET /v1/data-centers/{dataCenterId}/clusters][%d] ListClusters default  %+v", o._statusCode, o.Payload)
}
...
func (o *ListClustersDefault) GetPayload() *models.Status {
	return o.Payload
}
