...
// WithDataCenterID adds the dataCenterID to the list hosts params
func (o *ListHostsParams) WithDataCenterID(dataCenterID string) *ListHostsParams {
	o.SetDataCenterID(dataCenterID)
	return o
}

// SetDataCenterID adds the dataCenterId to the list hosts params
func (o *ListHostsParams) SetDataCenterID(dataCenterID string) {
