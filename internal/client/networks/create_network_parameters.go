...
func (o *CreateNetworkParams) WithBody(body *models.CreateNetworkBody) *CreateNetworkParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create network params
func (o *CreateNetworkParams) SetBody(body *models.CreateNetworkBody) {
	o.Body = body
}

// WithProjectID adds the projectID to the create network params
func (o *CreateNetworkParams) WithProjectID(projectID string) *CreateNetworkParams {
	o.SetProjectID(projectID)
	return o
}

// SetProjectID adds the projectId to the create network params
func (o *CreateNetworkParams) SetProjectID(projectID string) {
